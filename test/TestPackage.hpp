...
void t_create_package()
{
    ...
    matCu->SetProperty(Material::THERMAL_CONDUCTIVITY, --nano::Create<MaterialPropPolynomial>(std::vector<std::vector<NSFloat>>{{437.6, -0.165, 1.825e-4, -1.427e-7, 3.979e-11}}));
    matCu->SetProperty(Material::SPECIFIC_HEAT, --nano::Create<MaterialPropPolynomial>(std::vector<std::vector<NSFloat>>{{342.8, 0.134, 5.535e-5, -1.971e-7, 1.141e-10}}));
    ...
    matSiC->SetProperty(Material::THERMAL_CONDUCTIVITY, --nano::Create<MaterialPropPolynomial>(std::vector<std::vector<NSFloat>>{{1860, -11.7, 0.03442, -4.869e-5, 2.675e-8}}));
    matSiC->SetProperty(Material::SPECIFIC_HEAT, --nano::Create<MaterialPropPolynomial>(std::vector<std::vector<NSFloat>>{{-3338, 33.12, -0.1037, 0.0001522, -8.553e-8}}));
    ...
    matAlN->SetProperty(Material::THERMAL_CONDUCTIVITY, --nano::Create<MaterialPropPolynomial>(std::vector<std::vector<NSFloat>>{{421.7867, -1.1262, 0.001}}));
    matAlN->SetProperty(Material::SPECIFIC_HEAT, --nano::Create<MaterialPropPolynomial>(std::vector<std::vector<NSFloat>>{{170.2, -2.018, 0.032, -8.957e-5, 1.032e-7, -4.352e-11}}));
